# -*- coding: utf-8 -*-
#
# CHAOS API Documentation documentation build configuration file, created by
...
html_theme_options = {
    ...
    'versions': open('../versions.json').read().rstrip(),
}
...
htmlhelp_basename = 'CHAOSAPIDocumentationdoc'
